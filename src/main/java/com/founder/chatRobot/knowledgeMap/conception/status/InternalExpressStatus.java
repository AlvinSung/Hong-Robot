...
import com.founder.chatRobot.knowledgeMap.conception.status.common.ExpressStatus;
import com.founder.chatRobot.knowledgeMap.conception.taskType.common.TaskConception;

public abstract class InternalExpressStatus extends
		InternalExpressConception implements ExpressStatus {
	...
	public InternalExpressStatus(TaskConception treaderTask, String meetedInfo,
			String unmeetedInfo) {
